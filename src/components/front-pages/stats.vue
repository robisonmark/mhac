...
export default {
  ...
  computed: {
    ...
    games () {
      let gameFilter = [{game_id: '', home_team: {team_name: '',  level_name: 'All Levels'}, teams: 'All Games'}]
      ...
      return gameFilter.filter((game) => {
        // console.log("gameFilter", game)
        // console.log("if", game.home_team.level_name.toLowerCase() === this.filterBy.level.level.toLowerCase())
